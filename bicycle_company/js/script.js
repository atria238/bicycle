...
/* harmony import */ var _modules_imageToBackground_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/imageToBackground.js */ "./#src/js/modules/imageToBackground.js");
/* harmony import */ var _modules_menuToggle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/menuToggle */ "./#src/js/modules/menuToggle.js");
...
/***/ "./#src/js/modules/imageToBackground.js":
/*!**********************************************!*\
  !*** ./#src/js/modules/imageToBackground.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _isIE__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isIE */ "./#src/js/modules/isIE.js");
...
const smoothScrolling = (linkSelector) => {
	...
	const linkElements = document.querySelectorAll(linkSelector),
			burgger = document.querySelector('.menu__burgger'),
			menu = document.querySelector('.menu__body'),
			content = document.body;
    ...
    function calcAnchorTop() {
        ...
        linkElements.forEach(linkElem  => {
            linkElem.addEventListener('click', function(e) {
						burgger.classList.remove('menu__burgger-active');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tiny_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tiny-slider */ "./#src/js/modules/tiny-slider.js");


function slider () {

	let slider = Object(_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
/* harmony default export */ __webpack_exports__["default"] = (tns);
